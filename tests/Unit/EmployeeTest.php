...
//    {
//        $employee = EmployeeInformationModel::factory()->create(['user_id' => 99999, 'department_id' => 99999]);
...
//
//        $response->assertSessionHas('equipment', 'This employee has equipment assigned. Please remove it before deleting');
//
