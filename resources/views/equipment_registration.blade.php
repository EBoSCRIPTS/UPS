                    ...
                    <form action="{{route('equipment.add_equipment_type')}}" method="POST">
                        ...
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-danger mt-3" data-bs-toggle="modal"
                                    data-bs-target="#deleteEquipmentTypeModal">Delete type
                            </button>
                        </div>
                    </form>
                </div>
...
<!-- Modal -->
<div class="modal fade" id="deleteEquipmentTypeModal" tabindex="-1" aria-labelledby="deleteEquipmentTypeModal"
     aria-hidden="true">
