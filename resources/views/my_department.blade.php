                ...
                <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($employees as $employee)
                                    <tr>
                                        <td><a href="/profile/{{$employee->user_id}}">{{$employee->user->first_name}} {{$employee->user->last_name}}</a></td>
                    ...
                    <div class="col-md-6">
                        ...
                        @else
                            ...
                            <a class="" data-bs-toggle="collapse" href="#ticketInfo{{$ticket->id}}" role="button" aria-expanded="false" aria-controls="collapseExample" style="text-decoration: none">
                                <div class="card d-flex" style="max-width: 100%">
                                    <div class="card-body">
                                        ...
                                        <div class="collapse" id="ticketInfo{{$ticket->id}}">
                                            ...
                                            <a href="/departments/my/ticket_register/{{$ticket->id}}" class="btn btn-primary float-end">Seen, registered</a>
                                        </div>
                                </div>
                                </div>
                            </a>
