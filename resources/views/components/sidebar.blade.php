                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="/" class="nav-link align-middle px-0 mt-2">
                                <i class="fs-4 bi-house" style="color: white"></i> <span class="ms-1"
                                                                                         style="color: white">HOME</span>
                            </a>
                        </li>
                        <li>
                            @if(Auth::user()->role_id != 5)
                                ...
                                <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                    ...
                                    <li>
                                        <a href="/departments/my" class="nav-link px-2"> <span class=""
                                                                                               style="color: white">• My department</span>
                                        </a>
                                    </li>
                                </ul>
                        </li>
                        <li>
                            <a href="#submenu6" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                                <i class="fs-4 bi-clipboard" style="color: white"></i> <span class="ms-1 "
                                                                                             style="color: white">TASKS</span>
                            </a>
                        ...
                        @if(Auth::user()->role_id == 1)
                            <li>
                                ...
                                <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                                    <li class="w-100">
                                        <a href="/mng/register" class="nav-link px-0"> <span
                                                class="">Register New User</span></a>
                                    </li>
                                    <li>
