    ...
    <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3">
        <div class="container" style="width: 80%">
            ...
            <form action="{{route('create_new_project')}}" method="POST">
                ...
                <button type="button" class="btn btn-primary mt-1" data-bs-toggle="collapse"
                        data-bs-target="#projectSettings" aria-expanded="false" aria-controls="projectSettings">Create a
                    new project
                </button>
                <hr class="hr"/>
                ...
                <div class="collapse" id="projectSettings">
                    <div class="project-settings">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="project-status-fields">
                                    ...
                                    <button type="button" class="btn btn-primary mt-2" onclick="addField()">Add field
                                    </button>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <p class="h3">Project manager</p>
                                <select id="project_manager_id" name="project_manager_id" class="form-control mt-1"
                                        size="5">
                                ...
                                <button type="submit" class="btn btn-primary mt-5 float-end"
                                        onclick="return confirm('Are you sure?')">Finish creating new project
                                </button>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <select id="project_members" name="project_members[]" class="form-control mt-1"
                                        style="max-width: 300px" multiple size="10">
                                    @foreach($employees as $employee)
                                        <option
                                            value="{{$employee->id}}">{{$employee->id}} {{$employee->user->first_name}} {{$employee->user->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
