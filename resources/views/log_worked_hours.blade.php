                        ...
                        <table class="table">
                            ...
                            @foreach($dates as $date)
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="time" id="start_time{{$date}}"
                                               name="{{$date}}_start_time" min="00:00" max="24:00"
                                               onchange="calculateWorkedHours('{{$date}}')"/>
                                    </td>
                                    <td>
                                        <input class="form-control" type="time" id="end_time{{$date}}"
                                               name="{{$date}}_end_time" min="00:00" max="24:00"
                                               onchange="calculateWorkedHours('{{$date}}')"/>
                                    </td>
                                    <td>
                                        <select class="form-select" id="break_time{{$date}}" name="{{$date}}_break_time"
                                                onchange="calculateWorkedHours('{{$date}}')">
