                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" type="number" id="calculate_balance"
                                       name="calculate_balance" placeholder="Workdays spent">
                            </div>
                            <div class="col-sm-2">
                                <button type="button" class="btn btn-success" onclick="calculatePoints()">Calculate
                                </button>
                            </div>
                        </div>
                        ...
                        <form action="{{route('loghours.update_balance', $employeeDetails->user_id)}}" method="POST">
                            ...
                            <div class="row">
                                <input type="hidden" id="employee_id" name="employee_id"
                                       value="{{$employeeDetails->user_id}}">
                                <div class="col-sm-5">
                                    <label for="balance">Revoke points:</label>
                                </div>
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" id="balance" name="balance"
                                           placeholder="revoke_points">
                                </div>
                                <div class="col-sm-2">
                                    <button type="submit" class="btn btn-danger "
                                            onclick="return confirm('By revoking you approve the vacation')">Revoke
                                    </button>
                                </div>
                            </div>
                        </form>
