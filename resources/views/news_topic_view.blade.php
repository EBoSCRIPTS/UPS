    ...
    <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-3">
        <div class="container" id="container" style="width: 80%">
            ...
            <div class="topic">
                ...
                <img src="{{ asset($topic[0]['news_image']) }}" class="rounded d-block mx-auto img-fluid"
                     id="coverPhoto" alt="...">
                        ...
                        <div class="card-body bg-light">
                            ...
                            <div class="float-end">
                                <div class="row">
                                    <div class="col-sm-6">
                                        {{$comment->agree}}
                                        <a href="/news/view_topic/{{$topic[0]['id']}}/{{$comment->id}}/uprate">
                                    ...
                                    <div class="col-sm-6">
                                        {{$comment->disagree}}
                                        <a href="/news/view_topic/{{$topic[0]['id']}}/{{$comment->id}}/downrate">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
