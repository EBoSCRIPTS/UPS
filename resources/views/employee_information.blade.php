                    ...
                    <table class="table mt-3">
                        ...
                        @foreach($employees as $employee)
                            ...
                            <div class="modal fade" id="editModal{{$employee->id}}" tabindex="-1"
                                 aria-labelledby="editModal{{$employee->id}}_label" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModal{{$employee->id}}">Edit employee
                                                information</h5>
                                        </div>
                                        <div class="modal-body">
                                            <form action="{{route('employee_information.update')}}" method="POST">
                                                ...
                                                <input type="number" class="form-control" id="hours" name="hours"
                                                       placeholder="{{$employee->weekly_hours}}"/>
